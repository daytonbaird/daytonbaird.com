...
const projects = [
  ...
  },
  {
    name: 'Query Enhancer',
    description:
      'A command line search engine that allows the user to search for what was said inside a YouTube video via autogenerated captions. Built with Python for Sunhacks 2018.',
    tags: [
      {
        name: 'python',
        color: 'blue-text-gradient',
